...
public class GeneralExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(RentCouldNotFoundByIdException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<?> handleGetCarById(Exception ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ex.getMessage());
    }
    @ExceptionHandler(CarCannotBeRentedException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<?> handleCarCannotBeRented(Exception ex) {
